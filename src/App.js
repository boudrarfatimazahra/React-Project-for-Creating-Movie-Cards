...
import AnimeSite from './Pages/Pages/AnimeSite';
    ...
    return (
        <div className="App">
            <BrowserRouter>
                <NavBar />
                <Routes>
                    <Route path='/' element={<Home list={cardList} />} />
                    <Route path='/Movie' element={<Movies list={cardList} />} />
                    <Route path='/AnimeSite' element={<AnimeSite />} />
